...
import PlaceDetail from 'views/Place';
...
import SearchMap from 'views/Map/SearchMap';
...
function App() {
  ...
  const getSignInUserResponse = (responseBody: GetSignInUserResponseDto | ResponseDto | null) => {
    ...
    const signInUser: User = { ...responseBody as GetSignInUserResponseDto };
...
// description: 유저 페이지: '/user/:userid' - User //
// description: 게시물 상세보기: 'board/detail' - BoardDetail //
// description: 게시물 작성하기: 'board/write' - BoardWrite //
// description: 게시물 수정하기: 'board/update/:boardNumber' - BoardUpdate //
// description: 장소 페이지: '/place-detail' - PlaceDetail
  return (
    <> 
      <Routes>
